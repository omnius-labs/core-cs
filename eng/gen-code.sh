...
# "$TOOL_PATH" compile -s "$PWD/fmt/Omnius.Core.RocketPack.Tests/Omnius.Core.RocketPack.Tests.Internal.rpd" -o "$PWD/test/Omnius.Core.RocketPack.Tests/Internal/_RocketPack/Messages.generated.cs"
