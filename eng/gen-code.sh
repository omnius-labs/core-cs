...
"$TOOL_PATH" -f "$PWD/fmt/FormatterBenchmarks/FormatterBenchmarks.Internal.rpd" -i "$INCLUDE" -o "$PWD/perf/FormatterBenchmarks/Internal/_RocketPack/Messages.generated.cs"
...
"$TOOL_PATH" -f "$PWD/fmt/Omnius.Core.Network/Omnius.Core.Network.Connections.Secure.V1.Internal.rpd" -i "$INCLUDE" -o "$PWD/src/Omnius.Core.Network/Connections/Secure/V1/Internal/_RocketPack/Messages.generated.cs"

"$TOOL_PATH" -f "$PWD/fmt/Omnius.Core.Remoting/Omnius.Core.Remoting.rpd" -i "$INCLUDE" -o "$PWD/src/Omnius.Core.Remoting/_RocketPack/Messages.generated.cs"

"$TOOL_PATH" -f "$PWD/fmt/Omnius.Core.Serialization.RocketPack.DefinitionCompiler.Tests/Omnius.Core.Serialization.RocketPack.DefinitionCompiler.Tests.Internal.rpd" -i "$INCLUDE" -o "$PWD/test/Omnius.Core.Serialization.RocketPack.DefinitionCompiler.Tests/Internal/_RocketPack/Messages.generated.cs"
