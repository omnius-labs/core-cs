...
using System.Text;
using Omnix.Base;
using Omnix.Serialization.OmniPack.Internal;

namespace Omnix.Serialization.OmniPack
{
    /// <summary>
    /// OmniPackフォーマットのデシリアライズ機能を提供します。
    /// </summary>
    public unsafe ref struct OmniPackReader
    {
        ...
        public OmniPackReader(ReadOnlySequence<byte> sequence, in BufferPool bufferPool)
        {
