...
namespace Omnix.Network.Connections.Secure.V1.Internal
{
    ...
    internal sealed partial class VerificationMessage : global::Omnix.Serialization.OmniPack.IOmniPackMessage<VerificationMessage>
    {
        public static global::Omnix.Serialization.OmniPack.IOmniPackFormatter<VerificationMessage> Formatter { get; }
        ...
        private sealed class ___CustomFormatter : global::Omnix.Serialization.OmniPack.IOmniPackFormatter<VerificationMessage>
        {
            public void Serialize(ref global::Omnix.Serialization.OmniPack.OmniPackWriter w, in VerificationMessage value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public VerificationMessage Deserialize(ref global::Omnix.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
    ...
    internal sealed partial class AuthenticationMessage : global::Omnix.Serialization.OmniPack.IOmniPackMessage<AuthenticationMessage>
    {
        public static global::Omnix.Serialization.OmniPack.IOmniPackFormatter<AuthenticationMessage> Formatter { get; }
        ...
        private sealed class ___CustomFormatter : global::Omnix.Serialization.OmniPack.IOmniPackFormatter<AuthenticationMessage>
        {
            public void Serialize(ref global::Omnix.Serialization.OmniPack.OmniPackWriter w, in AuthenticationMessage value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public AuthenticationMessage Deserialize(ref global::Omnix.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
