...
{
    public sealed partial class OmniAddress : global::Omnix.Serialization.OmniPack.IOmniPackMessage<OmniAddress>
    {
        public static global::Omnix.Serialization.OmniPack.IOmniPackFormatter<OmniAddress> Formatter { get; }
        ...
        private sealed class ___CustomFormatter : global::Omnix.Serialization.OmniPack.IOmniPackFormatter<OmniAddress>
        {
            public void Serialize(ref global::Omnix.Serialization.OmniPack.OmniPackWriter w, in OmniAddress value, in int rank)
            {
            ...
            public OmniAddress Deserialize(ref global::Omnix.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
    ...
    public sealed partial class OmniPath : global::Omnix.Serialization.OmniPack.IOmniPackMessage<OmniPath>
    {
        public static global::Omnix.Serialization.OmniPack.IOmniPackFormatter<OmniPath> Formatter { get; }
        ...
        private sealed class ___CustomFormatter : global::Omnix.Serialization.OmniPack.IOmniPackFormatter<OmniPath>
        {
            public void Serialize(ref global::Omnix.Serialization.OmniPack.OmniPackWriter w, in OmniPath value, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
            ...
            public OmniPath Deserialize(ref global::Omnix.Serialization.OmniPack.OmniPackReader r, in int rank)
            {
                if (rank > 256) throw new global::System.FormatException();
