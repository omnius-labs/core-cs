...
public unsafe class Base16 : IBytesToUtf8StringConverter
{
    ...
    public static Base16 Lower { get; } = new Base16(Base16Case.Lower);
    public static Base16 Upper { get; } = new Base16(Base16Case.Upper);

    internal Base16() : this(Base16Case.Lower) { }

    internal Base16(Base16Case base16Case)
    {
