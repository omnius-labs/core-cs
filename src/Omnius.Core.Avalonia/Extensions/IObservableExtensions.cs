...
public static class IObservableExtensions
{
    ...
    {
        return DelayWhen(source, delay, condition, CurrentThreadScheduler.Instance);
    }

    public static IObservable<T> DelayWhen<T>(this IObservable<T> source, TimeSpan delay, Func<T, bool> condition, IScheduler scheduler)
    {
        return source
