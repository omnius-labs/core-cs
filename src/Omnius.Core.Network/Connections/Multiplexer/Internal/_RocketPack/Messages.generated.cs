...
namespace Omnius.Core.Network.Connections.Multiplexer.Internal
{
    ...
    internal sealed partial class HelloMessage : global::Omnius.Core.Serialization.RocketPack.IRocketPackObject<HelloMessage>
    {
        ...
        static HelloMessage()
        {
            ...
            global::Omnius.Core.Serialization.RocketPack.IRocketPackObject<HelloMessage>.Empty = new HelloMessage(global::System.Array.Empty<CommunicatorVersion>());
        }
        ...
        public HelloMessage(CommunicatorVersion[] versions)
        {
            ...
            this.Versions = new global::Omnius.Core.Collections.ReadOnlyListSlim<CommunicatorVersion>(versions);
        ...
        public global::Omnius.Core.Collections.ReadOnlyListSlim<CommunicatorVersion> Versions { get; }
